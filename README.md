...
The dashboard monitors key metrics such as total sales, total orders, total quantity sold, and average order value. It also analyzes sales contribution by product category, brand, store, and sales staff. This interactive dashboard enables stakeholders to identify high-performing products, evaluate sales team performance, understand customer behavior, and support data-driven business decisions.
Technologies Used
Power BI
DAX
CSV Data
